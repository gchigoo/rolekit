...
# Task
- id: RK-20260728-DOG-S1
- kind: implementation
- objective: Create file src/dogfood-1.txt containing exactly the text dogfood-ok-1 and nothing else. Do not modify other files.
...
# Acceptance commands
- `node -e "const fs=require('fs');const t=fs.readFileSync('src/dogfood-1.txt','utf8').trim();process.exit(t==='dogfood-ok-1'?0:1)"` expect_exit=0

# Acceptance assertions
- src/dogfood-1.txt exists with exact content
