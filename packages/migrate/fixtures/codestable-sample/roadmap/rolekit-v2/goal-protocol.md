...
本文件复制到 `.codestable/roadmap/rolekit-v2/goal-protocol.md` 后，由 `/goal` 会话读取。详细执行规则拆到同目录子文档，避免单个 md 超过 300 行。

## 1. 先读文件

- `.codestable/roadmap/rolekit-v2/goal-state.yaml`
- `.codestable/roadmap/rolekit-v2/goal-plan.md`
- `.codestable/roadmap/rolekit-v2/rolekit-v2-roadmap.md`
- `.codestable/roadmap/rolekit-v2/rolekit-v2-items.yaml`
- `.codestable/roadmap/rolekit-v2/goal-features/*.md`
- `.codestable/roadmap/rolekit-v2/goal-protocol-feature-loop.md`
- `.codestable/roadmap/rolekit-v2/goal-protocol-gates.md`
- `.codestable/roadmap/rolekit-v2/goal-protocol-audit.md`
