...
```bash
python3 <cs-onboard skill 目录>/tools/codestable-goal-consistency-gate.py --roadmap .codestable/roadmap/rolekit-v2
```
...
写 `.codestable/roadmap/rolekit-v2/goal-audit.md`：
...
同时写 `.codestable/roadmap/rolekit-v2/goal-evidence-summary.md` 或在 goal-audit 第 7 节等价内嵌：
